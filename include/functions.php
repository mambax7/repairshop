...
function header_mod_garage()
{
    echo "<table width='100%'>\n
           <tr>\n
             <td align='center'><img src='../assets/images/logo.jpg' alt='' title=''></td>\n
           </tr>\n
            </table>\n
            <br>\n";
}
...
function xoops_tabAdminMenu($module, $file, $tabs)
{
    ...
    // Nice buttons styles
    $imgUrl = XOOPS_URL . '/modules/' . $module->getVar('dirname') . '/assets/images/admin';
    echo "<style type='text/css'>\n"
         . "#buttontop { float:left; width:100%; background: #e7e7e7; font-size:93%; line-height:normal; border-top: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; margin: 0; }\n"
         . "#buttonbar { float:left; width:100%; background: #e7e7e7 url('"
         . $imgUrl
         . "/bg.gif') repeat-x left bottom; font-size:93%; line-height:normal; border-left: 1px solid black; border-right: 1px solid black; margin-bottom: 12px; }\n"
         . "#buttonbar ul { margin:0; margin-top: 15px; padding:10px 10px 0; list-style:none; }\n"
         . "#buttonbar li { display:inline; margin:0; padding:0; }\n"
         . "#buttonbar a { float:left; background:url('"
         . $imgUrl
         . "/left_both.gif') no-repeat left top; margin:0; padding:0 0 0 9px; border-bottom:1px solid #000; text-decoration:none; }\n"
         . "#buttonbar a span { float:left; display:block; background:url('"
         . $imgUrl
         . "/right_both.gif') no-repeat right top; padding:5px 15px 4px 6px; font-weight:bold; color:#765; }\n"
