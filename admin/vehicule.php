...
switch ($op) {
    ...
    case 'archivevehicule':
        ...
        // faut-il avoir la possibilit� de conserver un v�hicule sur lequel des reparations ont ete effectu�es ?
...
if (empty($op)) {
    ...
    while ((list($id, $immat, $id_proprietaire, $id_marque, $gamme, $modele_version) = $xoopsDB->fetchRow($result)) !== false) {
        ...
        echo '<td class="odd" align="center"><A HREF="vehicule.php?op=modifvehicule&id=' . $id . '"><img src="../assets/images/edit.png"></a> </td>';
        echo '<td class="odd" align="center"><A HREF="vehicule.php?op=suprvehicule&id=' . $id . '"><img src="../assets/images/delete.png"></a></td>';
    }
    echo '</tr></table><br>';
