...
switch ($op) {
    ...
    case 'creatclient':
        ...
        $sql = sprintf("INSERT INTO %s (compte, rs, nom, prenom, adresse, cp, ville, teldom, telport, telbureau, telecopie, civilite, email, particulier_prof, permis, remise) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
                       $xoopsDB->prefix('garage_clients'), $compte, $rs, $nom, $prenom, $adresse, $cp, $ville, $teldom, $telport, $telbureau, $fax, $civilite, $email, $part_prof, $permis, $remise);
    ...
    case 'update':
        ...
        $sql = sprintf('UPDATE '
                       ...
                       . " SET compte='$compte', rs='$rs', nom='$nom', prenom='$prenom', adresse='$adresse', cp='$cp', ville='$ville', teldom='$teldom', telport='$telport', telbureau='$telbureau', telecopie='$fax', civilite='$civilite', email='$email', particulier_prof='$part_prof', permis='$permis', remise='$remise'  WHERE id=$id");
...
if (empty($op)) {
    ...
    while ((list($id, $nom, $prenom, $cp, $ville) = $xoopsDB->fetchRow($result)) !== false) {
        ...
        echo '<td class="odd" align="center"><A HREF="client.php?op=modifclient&id=' . $id . '"><img src="../assets/images/edit.png"></a> </td>';
        echo '<td class="odd" align="center"><A HREF="client.php?op=suprclient&id=' . $id . '"><img src="../assets/images/delete.png"></a></td>';
    }
    echo '</tr></table><br>';
