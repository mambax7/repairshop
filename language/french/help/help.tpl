<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_XXXX_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">This module is ....<b> <b>
    </p>
    ...
    <a href="https://www.gitbook.com/book/xoops/xoops-operations-guide/" target="_blank">XOOPS Operations Manual</a><b>
    <b>
