...
define('_MI_GARAGE_FORFAIT', 'Forfaits');
define('_MI_GARAGE_REPINPR', 'R&eacute;parations en cours');
define('_MI_GARAGE_REPSOLD', 'R&eacute;parations sold&eacute;e');
define('_MI_GARAGE_REPARCH', 'R&eacute;parations archiv&eacute;');
